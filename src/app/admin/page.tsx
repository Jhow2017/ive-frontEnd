...
const App: React.FC = () => {
    ...
    const pacientes = [
        ...
        },
        {
            ...
            ultimaConsulta: '19/02/2025',
        },
        {
            nome: 'Mariana Almeida Silva',
            cpf: '456.789.123-00',
            nascimento: '10/11/1995',
            contato: '(11) 94567-8901',
            ultimaConsulta: '20/02/2025',
        },
    ];
    const profissionais = [
        {
                                                ...
                                                (notification, index) => (
                                                    ...
                                                    >
                                                        <div className="flex items-start">
                                                            <div
                                                                className={`p-2 rounded-full ${notification.iconBg} mr-3`}
                                                            >
                                                                <i
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-lg shadow p-6">
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <button
                                        onClick={() =>
                                            setShowNewDiagnosticModal(true)
                                        }
                                        className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 !rounded-button whitespace-nowrap"
                                    >
                                        <i className="fa-solid fa-plus mr-2"></i>
                                ...
                                <div className="grid gap-6">
                                    {[
                                        ...
                                        {
                                            paciente: 'Mariana Almeida Silva',
                                            data: '19/02/2025',
                                            medico: 'Dr. Lucas Mendes',
                            ...
                            <div className="bg-white rounded-lg w-[600px] max-h-[80vh] overflow-y-auto">
                                <div className="p-6 border-b">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <button
                                            onClick={() =>
                                                setShowNewDiagnosticModal(false)
                                            }
                            ...
                            <div className="bg-white rounded-lg w-[400px]">
                                <div className="p-6">
                                    ...
                                    <p className="text-gray-600 text-center mb-6">
                                        ...
                                        paciente {selectedPatient.nome}? Esta
                                    ...
                                    <div className="flex justify-center space-x-3">
                                        ...
                                        <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 !rounded-button whitespace-nowrap">
                                            Confirmar Exclusão
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="email"
                                                    className="w-full border rounded-lg px-3 py-2"
                                                    defaultValue="joao.silva@clinicasaude.com"
                                                />
                                            </div>
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-1">
